...
CREATE TABLE "SubInterest" (
    ...
    CONSTRAINT "SubInterest_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UserInterest" (
    ...
    CONSTRAINT "UserInterest_pkey" PRIMARY KEY ("userId","subInterestId")
);
...
-- AddForeignKey
ALTER TABLE "SubInterest" ADD CONSTRAINT "SubInterest_interestId_fkey" FOREIGN KEY ("interestId") REFERENCES "Interest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserInterest" ADD CONSTRAINT "UserInterest_subInterestId_fkey" FOREIGN KEY ("subInterestId") REFERENCES "SubInterest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
